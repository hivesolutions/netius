...
* The country of an address is now resolved, instead of the lookup of it failing
...
* A configuration context can now be used to load a file, instead of failing on it
