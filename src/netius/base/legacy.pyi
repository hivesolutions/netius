...
def bytes(value: Any, encoding: str = ..., errors: str = "strict", force: bool = ...) -> bytes: ...
def str(value: Any, encoding: str = ..., errors: str = "strict", force: bool = ...) -> str: ...
def u(value: Any, encoding: str = ..., errors: str = "strict", force: bool = ...) -> str: ...
def ascii(value: Any, encoding: str = ..., errors: str = "replace") -> str: ...
...
def is_unittest(name: str = "unittest") -> bool: ...
