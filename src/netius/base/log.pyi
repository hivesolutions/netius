...
class LogstashHandler(Handler):
    ...
    def emit(self, record: LogRecord, raise_e: bool = ...): ...
    def flush(self, force: bool = ..., raise_e: bool = ...): ...
...
def patch_logging(): ...
def setup_logging(level: int | str | None = ..., default: str = ...): ...
def in_signature(callable: Callable[..., Any], name: str) -> bool: ...
def _trace(self: Logger, message: Any, *args, **kwargs): ...
